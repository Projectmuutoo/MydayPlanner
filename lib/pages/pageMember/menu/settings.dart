  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return PopScope(
          canPop: context.read<Appdata>().keepPage.keepPage ? false : true,
          child: Scaffold(
            body: SafeArea(
              child: Padding(
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            InkWell(
                              onTap:
                                  isLoadings || showShimmer ? null : myProfile,
                              borderRadius:
  ...
  void logout() async {
    ...
    if (responseLogout.statusCode == 200) {
      ...
      LogoutUserPostResponse response =
          logoutUserPostResponseFromJson(responseLogout.body);
