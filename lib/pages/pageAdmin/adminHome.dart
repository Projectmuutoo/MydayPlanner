...
class _AdminhomePageState extends State<AdminhomePage> {
  ...
  Future<void> updateTotalCounts() async {
    url = await loadAPIEndpoint();
    ...
    if (responseAllReport.statusCode == 200) {
      final jsonResponse = jsonDecode(responseAllReport.body);
      if (jsonResponse['reports'] != null) {
        totalReportCount = jsonResponse.length;
      }
    }
  }
